...
from std_msgs.msg import Bool, Float32   # ★ AEB용 Float32 추가
...
class PathFollower(Node):
    def __init__(self):
        super().__init__('sm_path_follower_test3')
    ...
    def aeb_callback(self, msg: Float32):
        ...
        # 값이 크게 변할 때만 디버그 로그 (너무 많이 안 찍히게)
    ...
    def timer_callback(self):
        ...
        # ★ AEB 스케일 적용 (0~1) – 장애물 없으면 1.0이라 기존과 동일
        v *= self.aeb_scale
